#!/bin/bash
CHAIN_ID="uni-3"
SNAP_PATH="$DAEMON_HOME/snapshots/"
LOG_PATH="$DAEMON_HOME/snapshots/snap_log.txt"
DATA_PATH="$DAEMON_HOME/data/"
...
echo time tar cf ${SNAP_PATH}/${SNAP_NAME} -C ${DATA_PATH} . &>>${LOG_PATH}
